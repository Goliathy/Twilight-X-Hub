...
TextBox.Position = UDim2.new(0.086, 0, 0.116, 0)
TextBox.Size = UDim2.new(0.702, 0, 0.053, 0)
TextBox.BackgroundColor3 = Color3.new(0, 0, 0)
TextBox.BackgroundTransparency = 0.53
TextBox.ZIndex = 3
...
TextBox.Parent = MainHubFrame_2

local UICornerBox = Instance.new("UICorner")
UICornerBox.CornerRadius = UDim.new(0.420, 0)
UICornerBox.Parent = TextBox

local EnterSearchButton = Instance.new("TextButton")
EnterSearchButton.Name = "EnterSearchButton"
EnterSearchButton.Position = UDim2.new(0.858, 0, 0.142, 0)
EnterSearchButton.Size = UDim2.new(0.107, 0, 0.053, 0)
EnterSearchButton.AnchorPoint = Vector2.new(0.5, 0.5)
EnterSearchButton.BackgroundColor3 = Color3.new(0.102, 0.416, 1.000)
EnterSearchButton.Text = ""
EnterSearchButton.ZIndex = 3
EnterSearchButton.Parent = MainHubFrame_2

local UICorner_55 = Instance.new("UICorner")
UICorner_55.Name = "UICorner"
UICorner_55.CornerRadius = UDim.new(0.100, 0)
UICorner_55.Parent = EnterSearchButton

local UIStroke_56 = Instance.new("UIStroke")
UIStroke_56.Name = "UIStroke"
UIStroke_56.Color = Color3.new(0.094, 0.337, 1.000)
UIStroke_56.Thickness = 1.75
UIStroke_56.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
UIStroke_56.Parent = EnterSearchButton

local UIGradient_57 = Instance.new("UIGradient")
UIGradient_57.Name = "UIGradient"
UIGradient_57.Color = ColorSequence.new({ColorSequenceKeypoint.new(0.000, Color3.new(1.000, 1.000, 1.000)), ColorSequenceKeypoint.new(1.000, Color3.new(1.000, 1.000, 1.000))})
UIGradient_57.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0.000, 0.000, 0.000), NumberSequenceKeypoint.new(1.000, 0.000, 0.000)})
UIGradient_57.Rotation = 80
UIGradient_57.Parent = EnterSearchButton

local BtnText = Instance.new("TextLabel")
BtnText.Size = UDim2.new(0.8, 0, 0.8, 0)
...
BtnText.Parent = EnterSearchButton

local UIStroke_59 = Instance.new("UIStroke")
UIStroke_59.Name = "UIStroke"
UIStroke_59.Color = Color3.new(0.114, 0.075, 0.000)
UIStroke_59.Thickness = 3
UIStroke_59.Parent = BtnText

local ScriptList_7 = Instance.new("ScrollingFrame")
ScriptList_7.Name = "ScriptList"
ScriptList_7.Position = UDim2.new(0.086, 0, 0.177, 0)
ScriptList_7.Size = UDim2.new(0.826, 0, 0.768, 0)
...
local CloseHubButton = Instance.new("TextButton")
CloseHubButton.Name = "CloseHubButton"
CloseHubButton.Position = UDim2.new(0.945, 0, 0.051, 0)
CloseHubButton.Size = UDim2.new(0.049, 0, 0.076, 0)
CloseHubButton.AnchorPoint = Vector2.new(0.5, 0.5)
CloseHubButton.BackgroundTransparency = 1
CloseHubButton.ZIndex = 4
CloseHubButton.Text = ""
CloseHubButton.Parent = MainHubFrame_2

local FrameGradient = Instance.new("Frame")
FrameGradient.Name = "FrameGradient"
FrameGradient.Position = UDim2.new(-0.022, 0, 0.041, 0)
FrameGradient.Size = UDim2.new(1, 0, 1, 0)
FrameGradient.BackgroundColor3 = Color3.new(1, 0.2, 0.2)
FrameGradient.ZIndex = 3
FrameGradient.Parent = CloseHubButton

local UIGradient_62 = Instance.new("UIGradient")
UIGradient_62.Name = "UIGradient"
UIGradient_62.Color = ColorSequence.new({ColorSequenceKeypoint.new(0.000, Color3.new(1.000, 0.220, 0.220)), ColorSequenceKeypoint.new(1.000, Color3.new(0.867, 0.051, 0.051))})
UIGradient_62.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0.000, 0.000, 0.000), NumberSequenceKeypoint.new(1.000, 0.000, 0.000)})
UIGradient_62.Rotation = 80
UIGradient_62.Parent = FrameGradient

local UICorner_65 = Instance.new("UICorner")
UICorner_65.Name = "UICorner"
UICorner_65.CornerRadius = UDim.new(0.100, 0)
UICorner_65.Parent = FrameGradient

local UIStroke_66 = Instance.new("UIStroke")
UIStroke_66.Name = "UIStroke"
UIStroke_66.Color = Color3.new(0.000, 0.000, 0.000)
UIStroke_66.Thickness = 1.25
UIStroke_66.ApplyStrokeMode = Enum.ApplyStrokeMode.Border
UIStroke_66.Parent = FrameGradient
...
CloseText.Parent = FrameGradient

local UIStroke_64 = Instance.new("UIStroke")
UIStroke_64.Name = "UIStroke"
UIStroke_64.Color = Color3.new(0.114, 0.075, 0.000)
UIStroke_64.Thickness = 3
UIStroke_64.Parent = CloseText
...
local DISCORD_LINK = "https://discord.gg/N4dA9uNZHY"
...
ExecuteScriptButton_45.Activated:Connect(function()
    if not currentItem then
        warn("No game selected")
        return
    end
    if not currentItem.url or currentItem.url == "" then
        warn("URL empty for this script, can't execute")
        return
    end

    local closeInfo = TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.In)
    local shrinkTween = TS:Create(MainHubFrame_2, closeInfo, {
        Size = UDim2.new(0, 0, 0, 0),
        BackgroundTransparency = 1
    })
    TS:Create(BgImageLabel_21, closeInfo, {ImageTransparency = 1}):Play()
    ...
    shrinkTween.Completed:Once(function()
        ...
        local ok, scriptContent = pcall(function()
            return game:HttpGet(currentItem.url)
        end)
        ...
        if ok then
            ...
            warn("URL not found my guy: " .. tostring(currentItem.url))
        end
    end)
end)
...
for i, item in ipairs(data) do
    ...
    ImageButton.Activated:Connect(function()
        ...
        TitleGameLabel_68.Text = "Game : " .. (item.game_name  or "?")
...
local function performSearch(query)
    local q = query:lower():gsub("^%s*(.-)%s*$", "%1")
    for _, child in pairs(ScriptList_7:GetChildren()) do
        if child:IsA("Frame") then
            if q == "" then
                child.Visible = true
            else
                local titleLabel = child:FindFirstChild("TitleGameLabel")
                local titleText = (titleLabel and titleLabel.Text or child.Name):lower()
                child.Visible = (titleText:find(q, 1, true) ~= nil)
            end
        end
    end
end
...
local function applyButtonAnimations(btn)
	...
	local hoverScl = 1.05
	local hoverColor = Color3.fromRGB(0, 170, 255)
	...
	btn.MouseEnter:Connect(function()
		if not isClicking then makeSizeTween(hoverScl, hoverColor):Play() end
	end)

	btn.MouseLeave:Connect(function()
		if not isClicking then makeSizeTween(1, origColor):Play() end
	end)

	btn.MouseButton1Down:Connect(function() -- press effect
		isClicking = true
		makeSizeTween(0.9, origColor):Play()
	end)
...
applyButtonAnimations(EnterSearchButton)

-- confirm search
EnterSearchButton.Activated:Connect(function()
...
CloseHubButton.Activated:Connect(function()
    -- shrink animation and 
	local closeInfo = TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.In)
	...
	-- wait until end animation before fully closing
